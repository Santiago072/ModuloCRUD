# Manual de Usuario - Módulo CRUD Encuestas (Versión 1.0.0)
...
3. Ingrese el número de contacto principal (Celular, Fijo, WhatsApp, etc.).
...
2. En la pantalla principal, haga clic en el botón blanco **"Exportar CSV"**.
